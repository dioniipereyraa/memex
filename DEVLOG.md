...
- **Next.** Address the UX question of WHERE `memex sync now` runs (terminal vs claude.ai, and multiple open chats) before the release. Then the PR, tag/publish 0.4.4.

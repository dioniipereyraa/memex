...
- 0.1.0/0.1.1 → 0.2.0 (Phase 4 remote connector + Phase 6 Claude Code ingestion + resource hardening) → 0.2.1 (red-team round 4 redaction-bypass patch) → 0.2.2 (capture server embeds in a subprocess). Both PUBLISHED on PyPI. 496 tests green.
